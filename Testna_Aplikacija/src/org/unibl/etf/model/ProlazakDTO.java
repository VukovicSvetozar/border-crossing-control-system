...
import static org.unibl.etf.utility.ConstantsUtil.SEPARATOR;
...
public class ProlazakDTO implements java.io.Serializable {
	...
	public ProlazakDTO(java.lang.String id, java.lang.String idOsoba, java.lang.String informacije,
			java.lang.String[] odabraniFajlovi, java.lang.String status) {
		this.id = id;
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.idOsoba == null && other.getIdOsoba() == null)
						|| (this.idOsoba != null && this.idOsoba.equals(other.getIdOsoba())))
				&& ((this.informacije == null && other.getInformacije() == null)
						|| (this.informacije != null && this.informacije.equals(other.getInformacije())))
	...
	public synchronized int hashCode() {
		...
		if (getOdabraniFajlovi() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getOdabraniFajlovi()); i++) {
