...
public class ObavjestenjeServis {
	...
	public static void posaljiObavjestenje(String poruka) {
	...
	public static void azurirajInformacije(ProlazakDTO prolazak, String poruka) {
		String informacije = prolazak.getInformacije();
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm:ss yyyy-MM-dd");
		String vrijeme = LocalDateTime.now().format(formatter);
		String informacija = vrijeme + "\n\t\t" + poruka;
		StringBuilder sb = new StringBuilder(informacije);
		sb.append(informacija + "\n");
		informacije = sb.toString();
		prolazak.setInformacije(informacije);
		ObavjestenjeServis.posaljiObavjestenje(OBAVJESTENJE_INFO + SEPARATOR_KORISNIK + prolazak.getId());
	}
